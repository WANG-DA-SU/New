    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NightActivity.this.startActivity(new Intent(NightActivity.this, WebViewActivity.class));
            }
        });
        ...
        if (crA != null) {
            crA.addListener(new SimpleAnimListener() {
                ...
                public void onAnimationEnd(CRAnimation animation) {
                    ...
                    if (SkinConfig.getSkinStyle(NightActivity.this) == SkinStyle.Dark) {
                        skinStyle = SkinStyle.Light;
                    } else {
                        skinStyle = SkinStyle.Dark;
                    }
                    SkinCompat.setSkinStyle(NightActivity.this, skinStyle, mSkinStyleChangeListenerImp) ;
                }
            });
            crA.start();
